  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Base de Clientes</h1>
          <p className="text-gray-400 text-sm">Total de {clients.length} clientes registrados.</p>
        </div>
        <button 
          onClick={exportCSV}
          className="bg-white/5 border border-white/10 px-4 py-2.5 rounded-xl font-bold flex items-center gap-2 hover:bg-white/10 transition-all text-sm self-start"
        >
